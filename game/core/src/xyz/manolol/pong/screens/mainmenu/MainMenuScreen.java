    ...
    public MainMenuScreen() {
        ...
        textButton.addListener(new ChangeListener() {
            ...
            public void changed(ChangeListener.ChangeEvent event, Actor actor) {
                Pong.GAME.setScreen(new GameScreen(1));
            }
        });
        ...
        textButton.addListener(new ChangeListener() {
            @Override
            public void changed(ChangeListener.ChangeEvent event, Actor actor) {
                Pong.GAME.setScreen(new GameScreen(2));
            }
        });
        ...
        textButton.addListener(new ChangeListener() {
            @Override
            public void changed(ChangeListener.ChangeEvent event, Actor actor) {
                Pong.GAME.setScreen(new GameScreen(3));
            }
        });
        playerSelectionTable.add(textButton).padBottom(50).width(400).padRight(50);
        ...
        textButton.addListener(new ChangeListener() {
            @Override
            public void changed(ChangeListener.ChangeEvent event, Actor actor) {
                Pong.GAME.setScreen(new GameScreen(4));
            }
        });
        playerSelectionTable.add(textButton).padBottom(50).width(400).row();

        root.add(playerSelectionTable).row();
    }
